...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        "peer size-4 shrink-0 rounded-[4px] border-2 border-foreground/55 bg-background shadow-xs outline-none transition-shadow",
        "dark:border-foreground/70 dark:bg-background",
