...
export async function GET(
  ...
  try {
    ...
    console.error("Admin: error fetching audit checklist:", error);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("Admin: error updating audit checklist:", error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error("Admin: error deleting audit checklist:", error);
