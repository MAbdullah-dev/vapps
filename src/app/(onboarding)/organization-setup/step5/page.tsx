...
const Step5 = () => {
  ...
  const onSubmit = (values: Step5SchemaType) => {
    ...
    console.log("Step 5 saved:", values);
  };
    ...
    <Form {...form}>
      <div className="space-y-8">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div>
            <FormField control={form.control} name="chartOfAccountsTemplate" render={({ field }) => (
              <FormItem>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <FormField control={form.control} name="defaultAssetAccount" render={({ field }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="defaultRevenueAccount" render={({ field }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="defaultExpenseAccount" render={({ field }) => (
              <FormItem>
